export default function Lab1() {
    return (
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-brownies">
          <li>Preheat the over to 375 degrees.</li>
          <li>Melt the butter and mix in with the cocoa powder.</li>
          <li>Add gluten free flour to that mixture.</li>
          <li>In a separate bowl, beat eggs with sugar.</li>
          <li>Combine the contents of the chocolaty bowl with the eggy bowl, mix and pour into greased 8x8 baking dish.</li>
          <li>Bake at 375 for 20 minutes.</li>
        ...
        <ul id="wd-your-books">
          <li>Tomorrow, Tomorrow, Tomorrow</li>
          <li>Wavewalker: Breaking Free</li>
          <li>The Seven Husbands of Evelyn Hugo</li>
          <li>Good Material</li>
          <li>Before We Were Strangers</li>
        </ul>
      </div>
      ...
      <br />
      <img id="wd-teslabot" src="/images/reactjs.png" height="200px" alt="react"/>
    </div>
